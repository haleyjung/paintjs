...
// Set initial canvas background color to white before stroke is loaded
ctx.fillStyle = "white";
...
if(canvas){
    ...
    // To prevent right click for saving image from the webpage (1)↴
